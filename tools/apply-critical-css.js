...
fs.writeFileSync(path.join(root, "critical-mobile.css"), critical);
...
const block =
  ...
  '  <link rel="stylesheet" href="critical-mobile.css?v=' + VER + '" media="(max-width:700px)" />\n' +
  "  <script>(function(){if(!window.matchMedia||!window.matchMedia('(max-width:700px)').matches)return;var l=document.createElement('link');l.rel='stylesheet';l.href='styles.min.css?v=" + VER + "';l.media='print';l.id='mobilecss';document.head.appendChild(l);function m(){l.media='all';}if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',m);else m();})();</script>\n" +
...
html = html.replace(/critical-mobile\.css\?v=\d+/g, "critical-mobile.css?v=" + VER);
